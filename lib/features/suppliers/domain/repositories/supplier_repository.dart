...
abstract class SupplierRepository {
  Future<List<SupplierEntity>> getSuppliers({String? search, bool forceRefresh = false});
  ...
  Future<List<PurchaseOrderEntity>> getPurchaseOrders({String? supplierId, bool forceRefresh = false});
}
